    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.createUser = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, existingUser, hashedPassword, newUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (existingUser) {
                                throw new common_1.ConflictException('Користувач з цим email вже існує');
                            }
        ...
        UserService_1.prototype.comparePasswords = function (plainTextPassword, hashedPassword) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.compare(plainTextPassword, hashedPassword)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (result.affected === 0) {
                                throw new common_1.NotFoundException("\u041A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447 \u0437 ID ".concat(id, " \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u0438\u0439"));
                            }
                            return [2 /*return*/];
                    }
                });
