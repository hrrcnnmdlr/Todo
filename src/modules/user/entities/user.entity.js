...
exports.User = void 0;
var todo_entity_1 = require("../../../../../../../../../../../../src/modules/todo/entities/todo.entity");
...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.todos = __runInitializers(_this, _todos_initializers, void 0);
            return _this;
        }
        return User_1;
    }(_classSuper));
    ...
    (function () {
        ...
        __esDecorate(null, null, _todos_decorators, { kind: "field", name: "todos", static: false, private: false, access: { has: function (obj) { return "todos" in obj; }, get: function (obj) { return obj.todos; }, set: function (obj, value) { obj.todos = value; } }, metadata: _metadata }, _todos_initializers, _instanceExtraInitializers);
