...
var Todo = function () {
    ...
    var Todo = _classThis = /** @class */ (function (_super) {
        ...
        function Todo_1() {
            ...
            _this.completed = __runInitializers(_this, _completed_initializers, void 0);
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.todos; })];
